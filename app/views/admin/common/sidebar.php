<div class="col-md-3">
    <div class="list-group">
        ...
        <a href="posts.php" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Posts<span class="badge"><?php echo $courseService->totalCourse(); ?></span></a>
